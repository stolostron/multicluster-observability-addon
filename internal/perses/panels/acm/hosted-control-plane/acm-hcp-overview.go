	...
	return panelgroup.AddPanel("Worker Nodes Capacities",
		...
		tablePanel.Table(
			tablePanel.WithColumnSettings([]tablePanel.ColumnSettings{
				...
				{Name: "node", Header: "Worker Node"},
				{Name: "cpu", Header: "CPU"},
				{Name: "memory", Header: "Memory (GiB)"},
				{Name: "endpoint", Hide: true},
				{Name: "instance", Hide: true},
				{Name: "job", Hide: true},
				{Name: "maxPods", Header: "Pod Limit"},
...
func NumberOfHCPsRequestBased(datasourceName string) panelgroup.Option {
	return panelgroup.AddPanel("Number of HCPs",
		...
		barPanel.Chart(
			barPanel.Calculation(common.LastNumberCalculation),
		),
		panel.AddQuery(
			query.PromQL(
				HCPPanelQueries["HCPStatusUnavailable"].Pretty(0),
		...
		panel.AddQuery(
			query.PromQL(
				HCPPanelQueries["HCPStatusAvailable"].Pretty(0),
		...
		panel.AddQuery(
			query.PromQL(
				HCPPanelQueries["RequestBasedHCPCapacity"].Pretty(0),
	...
	return panelgroup.AddPanel("QPS Settings",
		...
		tablePanel.Table(
			tablePanel.WithColumnSettings([]tablePanel.ColumnSettings{
				...
				{Name: "service", Hide: true},
				{Name: "tenant_id", Hide: true},
				{Name: "value", Header: "Query Rate (QPS)"},
				{Name: "rate", Header: "Load on API Server"},
			}),
			tablePanel.WithDensity("compact"),
		),
		panel.AddQuery(
...
func NumberOfHCPsQPSBased(datasourceName string) panelgroup.Option {
	return panelgroup.AddPanel("Number of HCPs ",
		...
		panel.AddQuery(
			query.PromQL(
				HCPPanelQueries["QPSBasedCapacityLow"].Pretty(0),
		...
		panel.AddQuery(
			query.PromQL(
				HCPPanelQueries["QPSBasedCapacityMedium"].Pretty(0),
		...
		panel.AddQuery(
			query.PromQL(
				HCPPanelQueries["QPSBasedCapacityHigh"].Pretty(0),
		...
		panel.AddQuery(
			query.PromQL(
				HCPPanelQueries["QPSBasedCapacityAverage"].Pretty(0),
...
func HCPList(datasourceName string) panelgroup.Option {
	return panelgroup.AddPanel("Hosted Control Plane List",
		...
		tablePanel.Table(
			tablePanel.WithCellSettings([]tablePanel.CellSettings{
				{
					Condition: tablePanel.Condition{
						Kind: tablePanel.ValueConditionKind,
						Spec: &tablePanel.ValueConditionSpec{Value: "false"},
					},
				...
				},
				{
					Condition: tablePanel.Condition{
						Kind: tablePanel.ValueConditionKind,
						Spec: &tablePanel.ValueConditionSpec{Value: "true"},
					},
					Text: "Ready",
				},
			}),
			tablePanel.WithColumnSettings([]tablePanel.ColumnSettings{
				{Name: "hcp_name", Header: "HCP name"},
				{Name: "timestamp", Hide: true},
				{Name: "value", Hide: true},
				{Name: "Value #A", Hide: true},
				{Name: "__name__", Hide: true},
				{Name: "cluster", Hide: true},
				{Name: "clusterID", Hide: true},
				{Name: "container", Hide: true},
				...
				{Name: "service", Hide: true},
				{Name: "tenant_id", Hide: true},
				{Name: "hcp_namespace", Header: "HCP namespace"},
				{Name: "ready", Header: "Status"},
