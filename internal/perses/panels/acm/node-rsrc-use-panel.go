		...
		panel.AddQuery(
			query.PromQL(
				promql.SetLabelMatchers(
					"instance:node_cpu_utilisation:rate1m{cluster=\"$cluster\", job=\"node-exporter\", instance=~\"$instance\"}", //nolint:misspell // upstream metric name
					labelMatchers,
				),
...
func NodeMemoryUtilization(datasourceName string, labelMatchers ...promql.LabelMatcher) panelgroup.Option {
	return panelgroup.AddPanel("Memory Utilization",
		...
		panel.AddQuery(
			query.PromQL(
				promql.SetLabelMatchers(
					"instance:node_memory_utilisation:ratio{cluster=\"$cluster\", job=\"node-exporter\", instance=~\"$instance\"}", //nolint:misspell // upstream metric name
					labelMatchers,
				),
				query.SeriesNameFormat("{{ instance }}"),
				dashboards.AddQueryDataSource(datasourceName),
	...
	return panelgroup.AddPanel("Net Utilization (Bytes Receive/Transmit)",
		...
		panel.AddQuery(
			query.PromQL(
				...
				query.SeriesNameFormat("instance={{ instance }}, Receive"),
				dashboards.AddQueryDataSource(datasourceName),
			),
		),
		panel.AddQuery(
			query.PromQL(
				...
				query.SeriesNameFormat("instance={{ instance }}, Transmit"),
				dashboards.AddQueryDataSource(datasourceName),
			),
		),
	)
	...
	return panelgroup.AddPanel("Net Saturation (Drops Receive/Transmit)",
		...
		panel.AddQuery(
			query.PromQL(
				...
				query.SeriesNameFormat("instance={{ instance }}, Receive drops"),
				dashboards.AddQueryDataSource(datasourceName),
			),
		),
		panel.AddQuery(
			query.PromQL(
				...
				query.SeriesNameFormat("instance={{ instance }}, Transmit drops"),
				dashboards.AddQueryDataSource(datasourceName),
			),
		),
	)
	...
	return panelgroup.AddPanel("Disk IO Utilization",
		...
		panel.AddQuery(
			query.PromQL(
				...
				query.SeriesNameFormat("instance={{ instance }}, device={{ device }}"),
				dashboards.AddQueryDataSource(datasourceName),
			),
		),
	)
	...
	return panelgroup.AddPanel("Disk Space Utilization",
		...
		panel.AddQuery(
			query.PromQL(
				...
				query.SeriesNameFormat("instance={{ instance }}, {{ device }}"),
				dashboards.AddQueryDataSource(datasourceName),
			),
		),
	)
