...
func healthChecker(getter addonutils.AddOnDeploymentConfigGetter, fields []agent.FieldResult, mc *v1.ManagedCluster, mcao *addonapiv1alpha1.ManagedClusterAddOn) error {
	if len(fields) == 0 {
