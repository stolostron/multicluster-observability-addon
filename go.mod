...
require (
	...
	github.com/openshift/cluster-logging-operator/api/observability v0.0.0-20241106184417-73a5857dc558
...
require (
	...
	github.com/grafana/loki/operator/api/loki v0.0.0-20241120225611-733d99fc5f4a // indirect
